    ...
    <div class="bg-[#99b865] fixed bottom-0 w-full max-w-screen-full mx-auto h-20 font-bold p-1 mt-11 md:flex justify-center items-center">
        ...
        <form id="expenseForm">
            ...
            <div class="flex flex-row gap-2">
                ...
                <div class="flex-auto">
                    <input type="text" pattern="[0-9]+([.,][0-9]+)?" name="amount" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--sc)]" placeholder="Amount" >
                </div>
                <div class="flex-auto">
