    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full bg-[var(--bg)] px-6 py-8 rounded-lg">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    <button type="submit" class="w-full bg-[var(--sc)] text-bg font-semibold py-2 px-4 rounded-md transition-colors duration-300 hover:bg-[var(--pc)] focus:outline-none focus:ring focus:ring-sc">Login</button>
                </div>
            </form>
