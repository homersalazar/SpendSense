        ...
        <div class="max-w-md w-full bg-[var(--bg)] px-6 py-8 rounded-lg">
            ...
            <form method="POST" action="{{ route('user.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" class="w-full border border-pc rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[var(--sc)]" required autofocus>
                    @error('name')
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="w-full border border-pc rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[var(--sc)]" required>
                </div>

                <div>
                    <button type="submit" class="w-full bg-[var(--sc)] text-white font-semibold py-2 px-4 rounded-md transition-colors duration-300 hover:bg-[var(--pc)] focus:outline-none focus:ring focus:ring-sc">Sign Up</button>
                </div>
            </form>
